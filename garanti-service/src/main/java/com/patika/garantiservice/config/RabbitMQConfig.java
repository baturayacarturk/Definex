package com.patika.garantiservice.config;
...
public class RabbitMQConfig {
    ...
    public Queue statusUpdate() {
        return new Queue("status.update.garanti");
    }
    @Bean
    public Binding statusUpdateBinding(TopicExchange topicExchange, Queue statusUpdate) {
        return BindingBuilder.bind(statusUpdate).to(topicExchange).with("status.update.garanti");
    }
    @Bean
